...
2. Using built-in solvers provided by Python and Matlab.
...
3. Generalise your code so that the source term $q$ can now depend on the solution $u$ as well as a parameter $\mu$.  Use your code to solve the steady Cahn--Hilliard equation
$$
...
4. Update your code so that it can account for any combination of Dirichlet, Neumann, and Robin boundary conditions.
    (a) Try using your code to solve the problem
    $$
