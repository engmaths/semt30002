...
* [PDF of demos](demos/Week03-DemosSlides.pdf)
...
## Real-world problem: coffee brewing
...
\end{align}
Here, $E = 10^4$ Pa is the Young's modulus and $K = 5.6 \times 10^{-10}$ m$^2$ Pa$^{-1}$ s$^{-1}$ is the hydraulic conductivity.  The Young's modulus measures the stiffness of the porous solid formed by the coffee grains, and $K$ characterises how easy it is for fluid to flow through the coffee grains.
...
1. Calculate the difference in fluid pressure at the top surface, $\Delta p = p(H,t) - p_a$ after 5, 10, 15, and 30 s have passed.  *Answers (to 3 significant figures): 154, 206, 20.6, -83.16 Pa*.
...
5\. See figure below
![Answer to Exercise 5](week03_q5.svg)