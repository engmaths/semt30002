...
* [Sparse vs dense array comparison code](sparse_vs_dense.py)
* [PDF of demos](demos/Week05-DemosSlides.pdf)
...
6. Solve the 2D Poisson equation with sparse matrices.  Use memory profiling to examine the memory saved by using sparse matrices.